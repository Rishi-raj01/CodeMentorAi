...
//     // New state for chat assistant
//     const [chatMessages, setChatMessages] = useState([]);
//     const [chatInput, setChatInput] = useState("");
//     // New state for refactor mode
...
//         setChatMessages(prevMessages => [...prevMessages, newMessage]); // Use functional update
//         setChatInput("");
//         console.log("send chat input called");
//         setLoading(true);
//         try {
//             const response = await axios.post("/api/v1/ai/chat-doubt", { // Assuming you have a /chat endpoint
//                 code: code,
//                 role:"expert",
//                 context: chatInput, // Correctly passing chatInput as context
//                 // language: language,
//             }
//         );
//       console.log("reply from ai is ",response.data)
//             // Ensure response.data.reply is a string before setting state.
...
//                 console.log("AI Response:", aiResponse.text); // Log AI response for debugging
//                 setChatMessages(prevMessages => [...prevMessages, aiResponse]); // Use functional update
    
//             } else {
//                 console.warn("AI returned an empty or invalid response:", response.data.reply);
//                 const errorResponse = { text: "AI returned an empty or invalid response.", sender: "ai" };
...
//             const errorResponse = { text: "Error communicating with AI", sender: "ai" };
//             setChatMessages(prevMessages => [...prevMessages, errorResponse]);
//         } finally {
//             setLoading(false);
//         }
...
//     // Refactor Mode function
//     const refactorCode = async () => {
//         setLoading(true);
//         try {
//             const response = await axios.post("/api/v1/ai/refactor", { // Assuming you have a /refactor endpoint
//                 code: code,
//                 language: language,
//             });

//             setRefactoredCode(response.data.refactoredCode);
//             setReview(`Refactored Code:\n${response.data.refactoredCode}`); // Display refactored code in review panel
//         } catch (error) {
//             console.error("Refactor error:", error);
//             setReview(`Error refactoring code. Please try again. Details: ${error.message}`);
//         } finally {
//             setLoading(false);
//         }
//     };
...
//                                 {/* Markdown Preview for Review/Refactor */}
//                                 <Markdown rehypePlugins={[rehypeHighlight]}>{review}</Markdown>
//                             </div>
//                         )}
//                         <div>
